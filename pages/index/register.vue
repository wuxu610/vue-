<template>
	<view>
		...
		<uni-forms class="myForm" ref="myForm" :modelValue="registerModel" :rules="rules" style="text-align: center;">
			...
			<button type="primary" @click="btnRegister" size="mini">用户注册</button>
		</uni-forms>
